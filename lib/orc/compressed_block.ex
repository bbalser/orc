defmodule Orc.CompressedBlock do
  ...
  @type t :: %__MODULE__{
          ...
          encoded_chunks: [Orc.EncodedChunk.t()],
          binary: binary,
          stats: Orc.Proto.ColumnStatistics.t()
        }

  defstruct type: nil, estimated_size: 0, encoded_chunks: [], binary: nil, stats: nil
  ...
  #       Orc.Statistics.merge(type, acc, stat)
  #     end)
